...
export default function Header() {
  return (
    <section className="bg-grayCream w-full font-luxury pt-0">
      <div className="max-w-screen-xl mx-auto px-4 grid md:grid-cols-2 items-center gap-8 min-h-screen">
        ...
        <div className="flex flex-col md:items-start md:justify-center items-center">
          ...
          <div className="block md:hidden w-full flex justify-center relative overflow-visible -mt-4 mb-2">
            <div className="relative w-[95vw] h-[390px]">
              <img
                src="/assets/photoHome.png"  // si está en public/assets
                alt="Hero image"
        ...
        <div className="hidden md:flex justify-center items-start relative px-4 pb-8 pt-0 bg-gradient-to-b from-grayCream via-[#efefef] to-[#efefef]">
          <div className="relative w-full h-[85vh] -mt-6 z-10 overflow-hidden">
            <img
              src="" // si está en public/assets
              alt="Hero image"

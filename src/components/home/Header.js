...
//         {/* Columna derecha - imagen (escritorio) */}
//         <div className="hidden md:flex justify-end items-start relative px-4 pb-8 pt-4 bg-gradient-to-b from-grayCream via-[#efefef] to-[#efefef]">
//           {/* <-- agregado md:mr-12 para empujar la imagen un poco hacia la derecha */}
//           <div className="relative w-full h-[85vh] z-10 overflow-hidden md:mr-12">
//             <img
//               src="/assets/imgEdit.png"
//               alt="Hero"
...
//         {/* Columna izquierda (texto + imagen móvil) */}
//         <div className="flex flex-col md:items-start md:justify-center items-center">

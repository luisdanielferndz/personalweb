...
//     description: "Dominio de arquitecturas web modernas, bases de datos y tecnologías. Desde el frontend hasta el backend, creo sistemas robustos y escalables. Experiencia en React, Node.js, Python y otras más. Enfoque en código limpio, mantenible y que realmente resuelva problemas de negocio.",
//   },
//   {
//     icon: Lightbulb,
//     title: "CREATIVIDAD",
//     subtitle: "Generación de ideas, visión de negocio y enfoque estructurado",
//     description: "La creatividad no es caos, es visión estructurada. Capacidad para ver oportunidades donde otros ven obstáculos, y convertir ideas abstractas en planes ejecutables.",
//   },
// ];
...
//               <div
//                 key={index}
//                 className="bg-fondoGrayClaro rounded-lg p-8 hover:shadow-lg transition-shadow duration-300"
//               >

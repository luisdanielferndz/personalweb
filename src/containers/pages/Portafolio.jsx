...
export default function Portfolio() {
  ...
  return (
    <div className={`min-h-screen transition-all duration-700 ${
      ...
      {/* Sections */}
      <main>
        <DeveloperHeroSection isDark={isDark} />
        <DeveloperAboutSection isDark={isDark} />
        <DeveloperSkillSection isDark={isDark} />
        <DeveloperProjectSection isDark={isDark} />
        <DeveloperTestimonialSection isDark={isDark} />
        <DeveloperContactSection isDark={isDark} />
      </main>
